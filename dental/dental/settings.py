...
SECRET_KEY = 'django-insecure-yf-^_s*j#h)ek&#p7-@x*eeyzi#tnq%ivw&zxdus)h2h!k&1c&'
...
INSTALLED_APPS = [
    'dental_management.apps.DentalManagementConfig',
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # This indicates PostgreSQL
        'NAME': 'dental',
        'USER': 'postgres',
        'PASSWORD': '6979samZ.@',
